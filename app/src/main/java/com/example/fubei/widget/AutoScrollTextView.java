...
public class AutoScrollTextView extends TextView {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mInterval = array.getInt(R.styleable.ADTextView_ad_text_view_interval, 5000);
        ...
        mFrontTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_front_size, Utils.dip2Dimension(getContext(), 17));
        mContentTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_content_size, Utils.dip2Dimension(getContext(), 17));
        array.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (mTexts != null) {
            ...
            canvas.drawText(back, 0, back.length(), (indexBound.right - indexBound.left), mY, mPaintContent);
